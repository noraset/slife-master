...
class PrivilegeFavoriteFragment : Fragment() {

    private var mAdapter: MyAdapter? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_privilege_favorite, container, false)
    }
    ...
    inner class MyAdapter(context: Context?) : RecyclerView.Adapter<ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view = LayoutInflater.from(context).inflate(R.layout.privilege_favorite_item, parent, false)
    ...
    companion object {
        @JvmStatic
        fun newInstance() = PrivilegeFavoriteFragment()
    }
}
